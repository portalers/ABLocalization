...
translate Tchinese murdochroute4_df443072:
    ...
    "帶著獎牌的學生們從精緻玻璃展示櫃中望著我們，裡面還有閃閃發亮、拋光過頭的銅獎盃，看上去跟剛上漆沒兩樣。"
...
translate Tchinese schoolexplorationmain_9b0a2ff8:
    ...
    ra "行啊，但我大部分時間應該都只會看著Murdoch盯著你的樣子。"
...
translate Tchinese schoolauditorium_fd0c6000:
    ...
    "我很確定布幕的位置跟上次來的時候不同，但我今天的記憶不太可靠。"
...
translate Tchinese schoolauditorium_106c53ee:
    ...
    "檢查完全排椅子以後我才放鬆了點，Murdoch和Ralph上了舞台。"
...
translate Tchinese schoolauditorium_7d40b192:
    ...
    "Jim翻白眼的聲音我是沒辦法聽到，但從他沉重的嘆氣聲也能聽出來。"
...
translate Tchinese schoolauditorium_4a3c3311:
    ...
    bl "誰他媽會在學校下課後躲布幕後面好幾個小時啊，Byrnes先生？"
...
translate Tchinese schoolauditorium_4c188c0d:
    ...
    bl "在這種時候做出那種事的人絕對有大問題，我可知道有個殺手還沒被人抓住。"
...
translate Tchinese schoolbasement_26d9329a:
    ...
    mu "我是有鑰匙，但需要用上的話，就代表裡面應該不會有不該出現的人在。"
...
translate Tchinese schoolbasement_24263d76:
    ...
    "來到樓梯底部把燈打開時，我以為會看到恐怖的景象，但就只是同樣的老舊垃圾地窖。"
...
translate Tchinese schoolbasement_7091dcfe:
    ...
    ji "那確實，但我好歹也能幫忙碰幾個箱子，看看有沒有東西會動。"
...
translate Tchinese schoolbasement_59aec4f2:
    ...
    "我們花了大概十分鐘翻找生銹秤子和散架的紙板後，覺得根本是在浪費時間。"
...
translate Tchinese schoolbasement_10fa0de2:
    ...
    "我這才反應過來，這女孩如此瘦小，卻能不費吹灰之力就把這麼大一本書拿著亂甩。"
...
translate Tchinese schoolbasement_ee6fc503:
    ...
    "她大概從沒被准許來到學校的這個區域，更別提被默許胡亂拆書架了。"
...
translate Tchinese schoolbasement_5f873187:
    ...
    "我望著一片漆黑，不知道為什麼，但我就是覺得有人正從樓梯底部盯著我看。"
...
translate Tchinese schoolbasement_81181aa9:
    ...
    "他甩上門的時候，我聽見了有人衝上來的跑步聲。" with hpunch
...
translate Tchinese schoolbasement_3db0a52f:
    ...
    "Blithe停下腳步，我跟Murdoch也停了下來，以免撞上她。"
...
translate Tchinese schoolbasement_b7064aa8:
    ...
    "Murdoch打開焚化爐的門，驚叫出聲。" with hpunch
...
translate Tchinese schoolclassroom_99ac4461:
    ...
    ji "他是不算受歡迎，但我們都沒想過會看到一個大男人死在我們眼前。"
...
translate Tchinese schoolclassroom_2c9d6fcf:
    ...
    "雖說確認學校哪裡{i}沒{/i}人在不算浪費時間，但總會令人時刻警戒。"
...
translate Tchinese schoolclassroom_21493a26:
    ...
    bl "但事情錯綜複雜，諒你也沒必要像Ayers先生一樣，不知道為了什麼而擔憂。"
...
translate Tchinese schooloffice_1a1c87a7:
    ...
    "一想到要是Gretchen現身掌握主導權，或者被她發現我接觸她的東西。"
...
translate Tchinese schooloffice_dbb9c469:
    ...
    "都是些諸如{i}「復活節餐會，但是每年！」{/i}和{i}「那車軸鬆了！」{/i}之類的瑣碎句子，比起考量更像是提醒。"
...
translate Tchinese schooloffice_223eb562:
    ...
    ra "你知道的，要不是已經檢查過了，我會賭一大筆錢會在這撞見你媽。"
...
translate Tchinese schooloffice_a86f6654:
    ...
    ra "我很難想像她能在不找時間獨自靜一靜的情況下，忍受驚慌失措的人們多長時間。"
...
translate Tchinese schooloffice_efa6fcad:
    ...
    ra "有人會寧願擔起重責大任好讓自己忙起來，也要避免獨自一人胡思亂想。"
...
translate Tchinese schooloffice_42f0a3e3:
    ...
    "我回想有次撞見Ethel在洗衣房清洗她下體上的棕櫚糖的場景，有助於我軟下來。"
...
translate Tchinese schooloffice_f63c765f:
    ...
    bl "{i}「今年秋天，Mary Applegater將被移送至P.S. 4，蘿莎營區。」{/i}"
...
translate Tchinese schooloffice_3a18319b:
    ...
    mu "{i}「今年秋天，Melissa Boike將被移送至P.S. 3，沛頓。」{/i}"
...
translate Tchinese schoollibrary_2686faaa:
    ...
    "不知道這是不是個錯誤，畢竟有人可能在暗中觀察我們，而且書架很高。"
...
translate Tchinese schoollibrary_55bf0f8f:
    ...
    ji "你知道當時的地理老師懶得把這個修好，直接跟大家說地球就是這麼動的嗎？"
...
translate Tchinese schoollibrary_7293d7aa:
    ...
    ji "這裡應該沒什麼好搜的了，我要回大廳看看其他人有什麼發現。"
...
translate Tchinese schoollibrary_ae3d71af:
    ...
    me "不過像Blithe那樣聰明堅強的人，不管什麼都能得心應手。"
...
translate Tchinese schoollibrary_780d8816:
    ...
    bl "不好意思，我習慣成自然了。小孩直呼大人的名字，通常是會被打的。"
...
translate Tchinese schoolconvos_dd737c58:
    ...
    cy "她經歷了這麼多，如果就這麼死了，自己都不好意思把{i}亡於火災{/i}幾個字刻在墓碑上吧。"
...
translate Tchinese schoolconvos_b9303fb6:
    ...
    mu "都已經過了[murdochchoices!t]，卻還是找不到Dahlia的蹤跡。"
...
translate Tchinese schoolconvos_ad359297:
    ...
    "還有其他幾個男孩，全都身穿無袖背心、戴著頭帶，坐在一條船邊，還有人拿著槳。"
...
translate Tchinese schoolconvos_324fdc0e:
    ...
    bl "我跟Melissa首先會聯絡家長，在鎮外找個地方暫住，等到事情安定下來。"
...
translate Tchinese schoolconvos_de0fb38a:
    ...
    ra "要是這禮拜雜貨店跟我們公寓沒被燒光或被人搶光，我或許會回去把一些東西帶走。"
...
translate Tchinese dahliaprogression_266f6bc5:
    ...
    dh "大腦則將這些粒子信息處理為形體與顏色，從而構築你視覺的一切。"
...
translate Tchinese dahliaprogression_efb2ccaa:
    ...
    dh "我是在邀請你思考光的性質呢，Ayers先生，畢竟你打擾了我的工作。"
...
translate Tchinese dahliaprogression_c72d02a1:
    ...
    "我只想帶她到她哥身旁，好讓她說點正常的話，但我總覺得她會反抗。"
...
translate Tchinese dahliaprogression_3395afe9:
    ...
    dh "我要是離開哪怕一瞬間，都可能會錯過什麼事，這些資料可是千載難逢的。"
...
translate Tchinese thirddahliaattempt_b38a0d11:
    ...
    m "他想見到你，我也{i}真心{/i}覺得妳去露面才能讓他放心。"
...
translate Tchinese dahliasuccess_f93dfcd3:
    ...
    dh "那我們便無從估量它照進從未經歷過的新介質後，會產生什麼行為。"
...
translate Tchinese dahliasuccess_403e5455:
    ...
    dh "你一定要知道的話，我其實是不想讓Murdoch牽連進接下來的事的。"
