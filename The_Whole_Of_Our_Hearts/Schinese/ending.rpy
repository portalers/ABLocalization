...
translate Schinese end_7592a7f3:
    ...
    narrator sideReece "感谢各位游玩The Whole of Our Hearts！"
...
# game/ending.rpy:79
translate Schinese end_72600ab3:

    # "Hopefully one day all backgrounds will be drawn, but the current ones will have to make do."
    "希望有朝一日所有背景都是手绘的，但现在就先这样将就一下。"

# game/ending.rpy:81
translate Schinese end_01aee3f4:
    ...
    "我还从伟大的{a=https://jjbbllkk.itch.io}Jeremy Leaird-Koch (Red Means Recording){/a} (@jjbbllkk.bsky.social)和{a=https://www.incompetech.com}Kevin Macleod{/a}这边取用了音乐。"
...
# game/ending.rpy:86
translate Schinese end_641027f0:
    ...
    "The Whole of Our Hearts是我{a=https://bsky.app/profile/thecrimsonflare.bsky.social}Moffet{/a} (@thecrimsonflare.bsky.social)编剧与编程的！"
