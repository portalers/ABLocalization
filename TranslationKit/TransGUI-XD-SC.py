...
button_1 = customtkinter.CTkButton(master=frame_2, text='\U0001F4C1 来源档案路径(旧翻资料)', command=button_callback1, font=customtkinter.CTkFont(family='STHeiti'))
...
button_2 = customtkinter.CTkButton(master=frame_2, text='\U0001F4C1 目标档案路径(新版未填)', command=button_callback2, font=customtkinter.CTkFont(family='STHeiti'))
button_2.grid(row=2, column=4, rowspan=1, columnspan=1, sticky="nsew", pady=(40,0), padx=0)


text_3 = customtkinter.CTkTextbox(master=frame_2, fg_color="#50577A", width=560, height=20)
text_3.insert("0.0", pathResult)
text_3.configure(state="disabled")
text_3.grid(row=3, column=2, rowspan=1, columnspan=2, sticky="nsew", pady=(60,0), padx=10)
button_3 = customtkinter.CTkButton(master=frame_2, text='\U0001F4C1 输出档案/只做选项修饰路径', fg_color='#41416A', hover_color='#2E2E5C', command=button_callback3, font=customtkinter.CTkFont(family='STHeiti'))
button_3.grid(row=3, column=4, rowspan=1, columnspan=1, sticky="nsew", pady=(60,0), padx=0)

button_4 = customtkinter.CTkButton(master=frame_2, text='\U000025B6  生成制作开始', font=customtkinter.CTkFont(family='STHeiti' ,size=40, weight='bold'), fg_color='#0091ea', width=400, height=120, command=button_callback4)
button_4.grid(row=7, column=3, rowspan=3, columnspan=2, sticky="nsw", pady=(120,0), padx=(0, 40))

button_5_label = customtkinter.CTkLabel(master=frame_2, text="只做选项修饰档案启动钮\n(重复内容删旧留新，修饰标点符号等等)\n！！！特别注意！！！\n如果开启使用'机翻'选项\n再点这个钮是整份当新的送去机翻", anchor="center", font=customtkinter.CTkFont(family='STHeiti'))
button_5_label.grid(row=7, column=2, sticky="sw", pady=(120,0), padx=(40, 10))
button_5 = customtkinter.CTkButton(master=frame_2, text='\U000025B6 只做选项修饰档案启动钮',font=customtkinter.CTkFont(family='STHeiti', size=18), fg_color='#6B728E', hover_color='#46466F', width=100, height=28, command=button_callback5)
