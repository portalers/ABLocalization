...
translate Tchinese strings:
    ...
    new "這個程式專案包含了許多許可證下的免費軟體，包括MIT許可證和GNU Lesser通用公共許可證。完整的軟體列表，包括全部原始碼的連結，可以在{a=https://www.renpy.org/l/license}這裡{/a}找到。"
    ...
    new "剪貼板語音已啟用。按 'shift+C' 來關閉。"

    # renpy/common/00preferences.rpy:618
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自動語音會說“[renpy.display.tts.last]”。按 'alt+shift+V' 來關閉。"
    ...
    new "嘗試回溯到之前的時間，這將允許你保存或選擇不同的選項。"
