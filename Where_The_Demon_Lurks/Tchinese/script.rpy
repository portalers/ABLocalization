...
translate Tchinese strings:
    ...
    new "高個子女士{#speakingName}"

    # game/script.rpy:80
    old "Short Man{#speakingName}"
    new "矮個子男士{#speakingName}"
