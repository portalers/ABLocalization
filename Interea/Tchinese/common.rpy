# TODO: Translation updated at 2022-06-21 11:29
...
translate Tchinese strings:
    ...
    new "本遊戲由{a=https://weibo.com/u/7429628292}北極光漢化組{/a}完成當地語系化工作，如需訪問漢化組QQ頻道，請{a=https://qun.qq.com/qqweb/qunpro/share?_wv=3&_wwv=128&inviteCode=2kr67C&from=246610&biz=ka}訪問此處{/a}。\n\n友情連結:獸人控索引{a=https://furrygames.top/zh-tw/games/Interea.html}訪問此處{/a}。\n\n本套裝程式含了由數個許可證授權的免費軟體，包括 MIT 許可證和 GNU 寬鬆通用公共許可證。完整軟體清單及原始程式碼連結，請{a=https://www.renpy.org/l/license}訪問此處{/a}。"
    ...
    new "\n{color=#cfc}✔ 已預載圖像（良好）{/color}\n{color=#fcc}✘ 未預載圖像（糟糕）{/color}\n{color=#fff}拖動來移動位置。{/color}"
    ...
    new "正在查驗 [displayable_name!q] 的樣式"
    ...
    new "目前圖形驅動程式版本可能過舊或未正確運行。這會導致圖形顯示緩慢或者錯誤。"
    ...
    new "在文字編輯器中打開追溯報告（traceback.txt）。"
    ...
    # game/a1s1.rpy:31
    old "He summons this being with a simple name."
    new "他用了一個簡單的名字召喚著這個存在。"